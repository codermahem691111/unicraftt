...
import webPic2 from "/images/home/digitalProduct/websites/2.png";
import webPic3 from "/images/home/digitalProduct/websites/3.png";
const images = [webPic1, webPic2, webPic3, webPic1];

const OurWebsites = () => {
  return (
    <section className="container">
      <SectionTitle title="Our Websites" />
